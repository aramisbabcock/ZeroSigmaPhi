...
@CucumberOptions(plugin = { "pretty", "html:target/cucumber-reports/cucumber.html",
		"json:target/cucumber-reports/cucumber.json", "rerun:target/failedrerun.txt",
		"org.cucumbertaf.testlib.CTAFBDDTestListener" }, features = {
				"src/test/resources" }, glue = { "org.cucumbertaf.stepdefs", "org.cucumbertaf.hooks" })
public class RunCucumberTest {
	...
	public Object[][] scenarios(ITestContext context) {
		...
		if (iterations != 0) {
			Globals.counterTracker.get().put("total_scenarios_count",
					Integer.parseInt(String.valueOf(lst.size() / iterations)));
		}
		return custom_obj;
	}
